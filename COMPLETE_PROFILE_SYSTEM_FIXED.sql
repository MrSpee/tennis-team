-- ================================================
-- VOLLSTÄNDIGES PROFIL-SYSTEM SETUP (KORRIGIERT)
-- ================================================
-- Dieses Script erstellt ein komplettes Profil-System
-- mit öffentlichen Spieler-Profilen und allen Features
-- PostgreSQL-kompatible Syntax ohne IF NOT EXISTS für Policies
-- ================================================
...
DROP POLICY IF EXISTS "Public read access to player profiles" ON public.players;
